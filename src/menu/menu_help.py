...
@statistics(text=menu_help["instructions_for_use"])
...
@statistics(
    text=menu_help["instructions_for_implementing_the_bot_in_the_chat"]
)
...
@statistics(text=menu_help["basic_commands_in_the_chat"])
