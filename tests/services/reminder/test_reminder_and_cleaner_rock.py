...
from services.reminder.reminder_and_cleaner_rock import reminder_zero, clear_rock
...
async def test_reminder_zero() -> None:
    ...
    with patch('services.reminder.reminder_and_cleaner_rock.send_msg',) as mock_send_msg:
        await reminder_zero()
...
async def test_clear_rock() -> None:
    ...
    with patch('services.reminder.reminder_and_cleaner_rock.reminder_zero',) as mock_send_msg:
        await clear_rock()
